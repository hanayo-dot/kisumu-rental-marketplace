export function IconWalk({ className = "w-5 h-5" }: { className?: string }) {
  return (
    <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 7a2 2 0 100-4 2 2 0 000 4zM9 14l2-2 4 4m0 0l2 4m-2-4l-4-4m-2 4l-4-2" />
    </svg>
  );
}
...
export function IconBed({ className = "w-5 h-5" }: { className?: string }) {
  return (
    <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 7v11m0-4h18m0 4V7m-9 3a2 2 0 100-4 2 2 0 000 4zM5 14v-3a1 1 0 011-1h12a1 1 0 011 1v3" />
    </svg>
  );
}
...
export function IconBath({ className = "w-5 h-5" }: { className?: string }) {
  return (
    <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 12v4a2 2 0 002 2h12a2 2 0 002-2v-4M4 12V7a3 3 0 013-3h3m-6 8h16m-4-8a2 2 0 100-4 2 2 0 000 4z" />
    </svg>
  );
}
